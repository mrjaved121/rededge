...
import 'package:suprapp/app/features/bike_ride/sheets/select_date_sheet.dart';
...
class EnterLocationSheet extends StatefulWidget {
  const EnterLocationSheet({super.key});

  @override
  State<EnterLocationSheet> createState() => _EnterLocationSheetState();
}

class _EnterLocationSheetState extends State<EnterLocationSheet> {
  bool hasText = false;
  ...
  void _showNewBottomSheet(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => SelectDateSheet(
        onScrollUp: () {
          Provider.of<BottomSheetProvider>(context, listen: false)
              .controller
              .animateTo(
              ...
              child: CustomScrollView(
                ...
                slivers: [
                  SliverPersistentHeader(
                    pinned: true,
                    delegate: _BikeBottomSheetHeaderDelegate(
...
class _BikeBottomSheetHeaderDelegate extends SliverPersistentHeaderDelegate {
  ...
  _BikeBottomSheetHeaderDelegate({
  ...
  @override
  bool shouldRebuild(_BikeBottomSheetHeaderDelegate oldDelegate) {
